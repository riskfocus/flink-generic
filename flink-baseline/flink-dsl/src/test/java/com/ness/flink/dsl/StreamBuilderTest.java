...
//            VALUES.containsAll(Set.of(TestEventString.fromKey("one"), TestEventString.fromKey("two"))));
    ...
    @Data
    @AllArgsConstructor
    public static class TestEventLong implements Event, FlinkKeyedAware<String> {
    ...
    @Data
    @AllArgsConstructor
    public static class TestEventString implements Event, FlinkKeyedAware<String>, KafkaKeyedAware {
    ...
    public static class TestSourceFunction extends FromElementsFunction<String> {
